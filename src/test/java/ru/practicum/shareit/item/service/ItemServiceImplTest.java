...
class ItemServiceImplTest {
    ...
    void findOne_whenItemFoundByOwner_thenReturnedItemWithBookingDto() {
        ...
        when(itemRepository.findById(itemId)).thenReturn(Optional.of(item));
        when(bookingRepository.findByItemAndStartIsBefore(eq(item), ArgumentMatchers.any(LocalDateTime.class)))
                .thenReturn(Optional.of(lastBooking));
        when(bookingRepository.findByItemAndFinishIsAfter(eq(item), ArgumentMatchers.any(LocalDateTime.class)))
